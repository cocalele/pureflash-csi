...
kubectl apply -f $repo/rbac-csi-pfbd.yaml
kubectl apply -f $repo/csi-pfbd-driverinfo.yaml
kubectl apply -f $repo/csi-pfbd-controller.yaml
kubectl apply -f $repo/csi-pfbd-node.yaml
